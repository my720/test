...
public class ProductListAction//extends ActionSupport implements SessionAware
{
	...
	public String execute()throws SQLException{
		...
		if(productName.equals(null)//データベースのデータ有無チェック
				&& (productName_kana.equals(null))
				&& (imageFilePath.equals(null))
				&& (imageFileName.equals(null))
				&& (price.equals(null))){
			setMessage("検索結果なしメッセージ");//商品情報が存在しない場合
		}
		return /*xxxx*/;
	}
